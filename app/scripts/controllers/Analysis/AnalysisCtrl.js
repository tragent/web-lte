...
/**
 * @ngdoc function
 * @name webLteApp.controller:AnalysisCtrl
 * @description
 * # AnalysisCtrl
 * Controller of the webLteApp
 */
angular.module('webLteApp')
  .controller('AnalysisCtrl', [ '$scope', '$location', 'DataService', 
  function ($scope, $location, DataService) {

      $scope.single = true;
      // $scope.result = 'aggregated';

      // initial data loading
      $(document).ready(function(){
        $scope.plotAggregatedGraphs();
        $('.scrollspy').scrollSpy();
      });
